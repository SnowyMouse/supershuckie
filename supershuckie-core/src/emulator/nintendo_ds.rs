...
impl NintendoDS {
    ...
    pub fn new_from_rom(rom: &[u8], sram: &[u8], clock: Box<dyn MonotonicTimestampProvider>) -> Self {
        Self {
            ...
            core: Core::new(rom, sram).expect("failed to make a core (TODO: HANDLE THIS ERROR)"),
